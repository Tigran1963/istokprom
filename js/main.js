...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('header')) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger').on('click', function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').toggleClass('no-scroll');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header').toggleClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger').toggleClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__wrap').toggleClass('active');
    });
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() <= '999') {
    ...
    window.addEventListener('resize', function () {
      ...
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width() >= '999' && jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header').hasClass('active')) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger').removeClass('active');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__wrap').removeClass('active');
      }
    });
    var elGeo = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__geo');
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).innerWidth() <= 999) {
      console.log(jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).innerWidth());
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__search').after(elGeo);
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__nav').before(elGeo);
    }
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-text-btn')) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-text-btn').on('click', function (event) {
      var textDots = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).parent('.reviews__item-text').find('.js-text-dots');
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).text() === 'Показать весь текст') {
        textDots.css('display', 'none');
        var textMore = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).next('.js-text-more');
        textMore.css('display', 'inline');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).before(textMore);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).text('Скрыть');
      } else {
        textDots.css('display', 'inline');
        var _textMore = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).prev('.js-text-more');
        _textMore.css('display', 'none');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).after(_textMore);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).text('Показать весь текст');
      }
    });
  }
...
if (document.querySelector('.reviews__list')) {
  var swiperReviews = new Swiper('.reviews__list', {
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1.1,
    spaceBetween: 12,
...
if (document.querySelector('.workers')) {
  var swiperTabs = new Swiper('.workers__tabs', {
    direction: 'horizontal',
    loop: false,
    slidesPerView: "auto",
    spaceBetween: 9,
  ...
  var swiperWorker = new Swiper('.workers__worker', {
    direction: 'horizontal',
    loop: false,
    autoHeight: true,
    slidesPerView: 1.1,
