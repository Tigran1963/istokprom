(() => {
    ...
    function initSliders() {
        if (document.querySelector(".articles-one__slider")) new core(".articles-one__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".articles-one-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".articles-one-button-prev",
                nextEl: ".articles-one-button-next"
            }
        });
        if (document.querySelector(".about-equiptment__slider")) new core(".about-equiptment__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".about-equiptment__control .swiper-button-prev",
                nextEl: ".about-equiptment__control .swiper-button-next"
            }
        });
        if (document.querySelector(".about-history__slider")) new core(".about-history__slider", {
            ...
            speed: 800,
            scrollbar: {
                el: ".about-history__years .swiper-scrollbar",
                draggable: true
            },
            navigation: {
                prevEl: ".about-history__slider-control .swiper-button-prev",
                nextEl: ".about-history__slider-control .swiper-button-next"
            },
            on: {
                slideChange: function(swiper) {
                    let activeIndex = swiper.realIndex;
                    let cards = document.querySelectorAll(".about-history__years-item");
                    cards.forEach(((item, index) => {
                        if (index === activeIndex) item.classList.add("is-active"); else item.classList.remove("is-active");
                    }));
                }
            }
        });
        ...
        if (document.querySelector(".clients__list")) {
            ...
            const resizeHandlerSlider = () => {
                if (document.body.clientWidth <= 499) {
                    if (yourSlider) yourSlider.destroy();
                    sliderInit();
                }
            };
            resizeHandlerSlider();
    ...
    da.init();
    const articlesNavItem = document.querySelectorAll(".articles__nav-item");
    if (articlesNavItem.length > 0) articlesNavItem.forEach((item => {
